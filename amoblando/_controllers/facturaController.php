...
//
        ...
        if (isset($_SESSION['s_cliente'])) {
            $this->_view->cliente         = $this->db->selectUsuarios($_SESSION['s_cliente']);
            if (isset($this->_view->cliente[0][11])) {
                $_SESSION['s_fk_doc_acron']   = $this->_view->cliente[0][11];
            }
        }
        $this->_view->productos           = $this->db->verProductos();
        $credits                          = $this->db->verCreditos();
        $this->_view->payment             = $this->db->verPagos();
        $this->_view->status_invoices     = $this->status_invoices;
...
// captura los datos que vienen por pos, desemcrita y almacena en varibles
        ...
        //
                ...
                // almacena en la pocion 0 "en el primer elemento del carrito"
                ...
                // captura todos los id del arreglo
                        if (in_array($ID, $idProducto)) {
                // verifica si en exiten duplicados
