...
class c_MySQLi extends mysqli
{
    public function __construct()
    {
        ...
        $dotenv->load();
        $this->conexion = mysqli_connect($_ENV['SPORTHEALTH_DB_HOST'], $_ENV['SPORTHEALTH_DB_USERNAME'], $_ENV['SPORTHEALTH_DB_PASSWORD'], $_ENV['SPORTHEALTH_DB_DATABASE'],) or die('Se genero un error de acceso ' . __LINE__);
    }
