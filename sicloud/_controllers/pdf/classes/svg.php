...
{
    var $svg_gradient;
//   array - contient les infos sur les gradient fill du svg classé par id du svg
    var $svg_shadinglist;
// array - contient les ids des objet shading
    var $svg_info;
//   array contenant les infos du svg voulue par l'utilisateur
    var $svg_attribs;
//    array - holds all attributes of root <svg> tag
    var $svg_style;
//   array contenant les style de groupes du svg
    var $svg_string;
//  String contenant le tracage du svg en lui même.
    var $txt_data;
//    array - holds string info to write txt to image
    var $txt_style;
//    array - current text style
    var $mpdf_ref;
    var $xbase;
// mPDF 4.4.003
    var $ybase;
...
// mPDF 4.4.003
    var $kp;
// mPDF 4.4.003  convert pixels to PDF units
...
// mPDF 5.0
        $this->mpdf_ref =& $mpdf;
        $this->kp = 72 / $mpdf->img_dpi;
// mPDF 4.4.003  constant To convert pixels to pts/PDF units
        $this->kf = 1;
// mPDF 5.0.039    constant To convert font size if re-mapped
        $this->pathBBox = array();
// mPDF 5.0.039
...
// mPDF 4.4.003
            ...
            } elseif ($gradient_info['info']['r'] || $gradient_info['info']['r'] === 0) {
...
*/
    ...
    function svgStyle($critere_style, $attribs, $element)
    {
        ...
        // mPDF 4.4.005   Used as indirect setting for currentColor
        elseif (strtolower($critere_style['fill']) == 'currentcolor') {
        ...
        } elseif ($critere_style['fill'] != 'none') {
...
*/
    ...
    function svgText()
    {
        ...
        if (isset($this->txt_data[2])) {
            ...
            } elseif ($current_style['text-anchor'] == 'end') {
    ...
    function svgDefineTxtStyle($critere_style)
    {
        ...
        if (isset($critere_style['font-family'])) {
            ...
            foreach ($aux_fontlist as $f) {
                ...
                if (
                    (!$this->mpdf_ref->usingCoreFont && in_array($v, $this->mpdf_ref->available_unifonts)) ||
                ...
                // mPDF 5.0.039    - Don't output stuff inside <defs>
                    ...
                    case 'stop':
                        ...
                        if (isset($attribs['style']) and preg_match('/stop-color:\s*([^;]*)/i', $attribs['style'], $m)) {
                            $color = trim($m[1]);
                        } elseif (isset($attribs['stop-color'])) {
