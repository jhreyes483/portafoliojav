...
// VISTA
   ...
   //
    public function edit()
    {
        ...
        if (count($categorias) == 0) {
            $this->_view->datos = ['response_status' => 'error', 'response_msg' => 'No hay datos de categoria' ];
        }
        if (count($categorias) == 0) {
            $this->_view->datos = ['response_status' => 'error', 'response_msg' => 'No hay datos de categoria' ];
        }
        if (count($medida) == 0) {
            $this->_view->datos = ['response_status' => 'error', 'response_msg' => 'No hay datos de medida' ];
        }
        if (count($producto) == 0) {
            $this->_view->datos = ['response_status' => 'error', 'response_msg' => 'El producto no existe' ];
        }
   ...
   // Agrega camtidad de un producto existente
    public function m_add()
    {
        ...
        if ($b == 1) {
            $_SESSION['message'] = 'Registro entrega';
