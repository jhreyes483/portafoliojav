...
if (isset($_POST)) {
    $log->m_escribeLineaParams('Petici�n POST', $_POST);
}
if (isset($_GET['default'])) {
    $log->m_escribeLinea('Petici�n GET', 'Default');
}
$log->m_cerrar();
...
if (isset($_POST['enviar']) && !isset($_GET['default'])) {
    if ((!isset($_POST['asunto']))    || $_POST['asunto']    == '') {
        $status  = 'error';
        $msg = 'No envio mensaje: Campo asunto vacio';
    }
    if ((!isset($_POST['body']))      || $_POST['body']      == '') {
        $status = 'error';
        $msg = 'No envio mensaje: Campo del mensaje vacio';
    }
    if ((!isset($_POST['mailEnvio'])) || $_POST['mailEnvio'] == '') {
        $status = 'error';
        $msg = 'No envio mensaje: Campo Correo a enviar vacio';
    }
    if ((!isset($_POST['titulo']))    || $_POST['titulo']    == '') {
        $status = 'error';
        $msg = 'No envio mensaje: Campo titulo vacio';
    }
    if ((!isset($_POST['remitente'])) || $_POST['remitente'] == '') {
        $status = 'error';
        $msg = 'No envio mensaje: Campo del Remitente vacio';
    }
   ...
   */
    ...
    $status = 'error';
    $smg = 'Error esperando datos de envio';
}
