...
class c_MySQLi extends mysqli
{
    ...
    {
        $this->DB_HOST = 'b04mo8bq4o8a3isczlwa-mysql.services.clever-cloud.com';
        $this->DB_USER = 'ut9r61pppuskjwlv';
        $this->DB_PASS = 'YWNeP06Rmpk8or3aQhrA';
        $this->DB_NAME = 'b04mo8bq4o8a3isczlwa';
        parent:: __construct();
    ...
    {
        $db = new c_MySQLi();
        $obj = ($db->m_ejecuta('SELECT MAX(' . $param[0] . ') from ' . $param[1] . ''));
        $i = 0;
