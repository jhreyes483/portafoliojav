            ...
            <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 class="h3 mb-0 ">
                     ...
                     <p class="typing" style="display: none; color: #0049E5 !important;    font-size: 22px;">
                        Javier Reyes Engineer
                     </p>

                  </h1>

                  <a class="nav-link dropdown-toggle d-none d-sm-inline-block btn btn-primary shadow-sm interactive-button" data-color="120" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     Informes</span>
                  </a>
